            ...
            <div class="login-box ptb--100">
                <form class="user" method="post" action="<?= base_url('Auth/cek_login'); ?>">
                    <div class="login-form-head">
                        <h4>Sign In</h4>
                        <p>Hello there, Sign in and Enjoy </p>
                    </div>
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="password" value="<?= set_value('nama'); ?>" name="password" id="password">
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted">Don't have an account? <a href="<?= base_url('Auth/registrasi') ?>">Sign up</a></p>
                        </div>
                    </div>
                </form>
            </div>
